    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div id ="exc"className="flex flex-1 justify-start items-start flex-col mf:mr-10">
                    <h1 className="text-6xl sm:text-7xl text-white text-gradient py-1">
                        ...
                        <div className="flex justify-between flex-col w-full h-full">
                            <div className="flex justify-between items-start">
                                <div className="w-10 h-10 rounded-full border-2 border-black flex justify-center items-center">
                                    <SiEthereum fontSize={25} color="#000" cursor="pointer" />
                                </div>
                                    <BsInfoCircle fontSize={20} color="#fff" cursor="pointer"/>
                            </div>
                            <div>
                                <p className="text-white font-light text-sm">
                                    {shortenAddress(currentAccount)}
                                </p>
                                <p className="text-white font-semibold text-lg mt-1 cursor-pointer">
                                    Ethereum
                                </p>
                            </div>
                        </div>
